...
state_data <- read.csv("./covid_report_county_region_date_1109.csv")
...
ggplot(data =state_data_by_week, aes(x = week_ind,y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=min(state_data_by_week$week_ind),to=max(state_data_by_week$week_ind), by = 1),labels = c("Feb25 - Mar02","Mar03 - Mar09","Mar10 - Mar16","Mar17 - Mar23","Mar24 - Mar30","Mar31 - Apr6","Apr7 - Apr13","Apr14 - Apr20","Apr21 - Apr27","Apr28 - May4","May5 - May11",
                                                                ...
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21","Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26", "Oct27 - Nov2", "Nov3 - Nox9"))+
  theme_bw()+
...
patient_data <- read_csv(file= "./UM1107.csv", na = c("", "#NUM!"))
...
patient_data_symptomatic <- read_csv(file = "./UM1107sx.csv", na = c("", "#NUM!"))
...
```{r, echo = FALSE,message=FALSE}
ratio_approximated <- PCR_prevalence_by_week$total_patient[2:28]/ PCR_prevalence_by_week_symptomatic$total_patient[1:27]
count_comparison <- data.frame(PCR_prevalence_by_week$pcr_week_ind[2:28], ratio_approximated)
...
count_comparison_plot <- ggplot(data =count_comparison, aes(x = count_comparison[,1] ,y =  count_comparison[,2] ))+
  ...
  scale_x_continuous(breaks=seq(from=min(count_comparison$PCR_prevalence_by_week.pcr_week_ind.2.28.),to=max(count_comparison$PCR_prevalence_by_week.pcr_week_ind.2.28.), by = 1),labels = c("May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26", "Oct27 - Nov2", "Nov3 - Nov9"))+
  theme_bw()+
...
IGG_ratio_approximated <- IGG_prevalence_by_week$total_patient[1:28]/ IGG_prevalence_by_week_symptomatic$total_patient[1:28]
IGG_count_comparison <- data.frame(IGG_prevalence_by_week$igg_week_ind[1:28], IGG_ratio_approximated)
...
IGG_count_comparison_plot <- ggplot(data =IGG_count_comparison, aes(x = IGG_count_comparison[,1] ,y =  IGG_count_comparison[,2] ))+
  ...
  scale_x_continuous(breaks=seq(from=min(IGG_count_comparison$IGG_prevalence_by_week.igg_week_ind.1.28.),to=max(IGG_count_comparison$IGG_prevalence_by_week.igg_week_ind.1.28.), by = 1),labels = c("Apr28 - May4","May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26", "Oct27 - Nov2", "Nov3 - Nov9"))+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),axis.text.y = element_text(size=9))
...
mrp_pcr_fit = readRDS("fit_pcr_1107.rds")
...
fit_pcr_symptomatic=readRDS("fit_pcr_symptomatic1027.rds")
...
week.inc = count_comparison$PCR_prevalence_by_week.pcr_week_ind.2.26.
...
sex_ratio <- data.frame(rep(seq(from = 20, to = 45, by = 1), 2),
                   c(sex_prevalence$prevalence_male[3:28]/sex_prevalence_symptotic$prevalence_male[2:27], sex_prevalence$prevalence_female[3:28]/sex_prevalence_symptotic$prevalence_female[2:27]),
                   c(rep("Male", length(sex_prevalence_symptotic$pcr_week_ind[2:27])),rep("Female", length(sex_prevalence_symptotic$pcr_week_ind[2:27]))))
...
ggplot()+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.25))+
  scale_x_continuous(breaks=seq(from=20,to=45, by = 1),labels = c(
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26", "Oct27 - Nov2", "Nov3 - Nov9"))+
  theme_bw()+
    theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),axis.text.y = element_text(size=9))+
...
#Starting from Week 20 to avoid 0/0
race_ratio <- data.frame(rep(seq(from = 20, to = 45, by = 1), 3),
                         c(race_prevalence$prevalence_white[3:28]/race_prevalence_symptotic$prevalence_white[2:27],
                           race_prevalence$prevalence_black[3:28]/race_prevalence_symptotic$prevalence_black[2:27],
                           race_prevalence$prevalence_other[3:28]/race_prevalence_symptotic$prevalence_other[2:27]),
                         c(rep("White", length(race_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Black", length(race_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Other", length(race_prevalence_symptotic$pcr_week_ind[2:27]))))
...
#Starting from Week 20 to avoid 0/0
age_ratio <- data.frame(rep(seq(from = 20, to = 45, by = 1), 5),
                         c(age_prevalence$prevalence_age1[3:28]/age_prevalence_symptotic$prevalence_age1[2:27],
                           age_prevalence$prevalence_age2[3:28]/age_prevalence_symptotic$prevalence_age2[2:27],
                           age_prevalence$prevalence_age3[3:28]/age_prevalence_symptotic$prevalence_age3[2:27],
                           age_prevalence$prevalence_age4[3:28]/age_prevalence_symptotic$prevalence_age4[2:27],
                           age_prevalence$prevalence_age5[3:28]/age_prevalence_symptotic$prevalence_age5[2:27]),
                         c(rep("Age0_17", length(age_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Age18_39", length(age_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Age40_64", length(age_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Age65_75", length(age_prevalence_symptotic$pcr_week_ind[2:27])),
                           rep("Age75+", length(age_prevalence_symptotic$pcr_week_ind[2:27]))))
...
mrp_pcr_fit= fit_pcr_spline
qq <- as.data.frame(fit_pcr_spline, pars = c("mean_y_rep_w1","mean_y_rep_w2","mean_y_rep_w3","mean_y_rep_w4","mean_y_rep_w5","mean_y_rep_w6","mean_y_rep_w7"，"mean_y_rep_w8","mean_y_rep_w9"))
...
names(list_sex_age) <-  c("sex_age_w1","sex_age_w2","sex_age_w3","sex_age_w4","sex_age_w5","sex_age_w6","sex_age_w7","sex_age_w8","sex_age_w9","sex_age_w10","sex_age_w11","sex_age_w12","sex_age_w13","sex_age_w14","sex_age_w15","sex_age_w16","sex_age_w17","sex_age_w18","sex_age_w19","sex_age_w20","sex_age_w21","sex_age_w22","sex_age_w23","sex_age_w24","sex_age_w25","sex_age_w26","sex_age_w27","sex_age_w28")
names(list_county_stan) <-  c("county_w1","county_w2","county_w3","county_w4","county_w5","county_w6","county_w7","county_w8","county_w9","county_w10","county_w11","county_w12","county_w13","county_w14","county_w15","county_w16","county_w17","county_w18","county_w19","county_w20","county_w21","county_w22","county_w23","county_w24","county_w25","county_w26","county_w27","county_w28")
names(list_age_stan) <-  c("age_w1","age_w2","age_w3","age_w4","age_w5","age_w6","age_w7","age_w8","age_w9","age_w10","age_w11","age_w12","age_w13","age_w14","age_w15","age_w16","age_w17","age_w18","age_w19","age_w20","age_w21","age_w22","age_w23","age_w24","age_w25","age_w26","age_w27","age_w28")
names(list_race_stan) <-  c("race_w1","race_w2","race_w3","race_w4","race_w5","race_w6","race_w7","race_w8","race_w9","race_w10","race_w11","race_w12","race_w13","race_w14","race_w15","race_w16","race_w17","race_w18","race_w19","race_w20","race_w21","race_w22","race_w23","race_w24","race_w25","race_w26","race_w27","race_w28")
names(list_sex_stan) <-  c("male_w1","male_w2","male_w3","male_w4","male_w5","male_w6","male_w7","male_w8","male_w9","male_w10","male_w11","male_w12","male_w13","male_w14","male_w15","male_w16","male_w17","male_w18","male_w19","male_w20","male_w21","male_w22","male_w23","male_w24","male_w25","male_w26","male_w27","male_w28")
names(list_week) <-  c("time_w1","time_w2","time_w3","time_w4","time_w5","time_w6","time_w7","time_w8","time_w9","time_w10","time_w11","time_w12","time_w13","time_w14","time_w15","time_w16","time_w17","time_w18","time_w19","time_w20","time_w21","time_w22","time_w23","time_w24","time_w25","time_w26","time_w27","time_w28")
supplementary_info <- list(offset = 0.5, n1 = N[1],n2 = N[2], n3 = N[3], n4 = N[4], n5 = N[5], n6 = N[6], n7 = N[7], n8 = N[8], n9 = N[9], n10 = N[10], n11 = N[11], n12 = N[12], n13 = N[13], n14 = N[14], n15 = N[15], n16 = N[16], n17 = N[17], n18 = N[18], n19 = N[19], n20 = N[20], n21 = N[21], n22 = N[22], n23 = N[23], n24 = N[24], n25 = N[25], n26 = N[26], n27 = N[27], n28 = N[28])
...
names(list_sex_age_symptomatic) <-  c("sex_age_w1","sex_age_w2","sex_age_w3","sex_age_w4","sex_age_w5","sex_age_w6","sex_age_w7","sex_age_w8","sex_age_w9","sex_age_w10","sex_age_w11","sex_age_w12","sex_age_w13","sex_age_w14","sex_age_w15","sex_age_w16","sex_age_w17","sex_age_w18","sex_age_w19","sex_age_w20","sex_age_w21","sex_age_w22","sex_age_w23","sex_age_w24","sex_age_w25","sex_age_w26","sex_age_w27")
names(list_county_stan_symptomatic) <-  c("county_w1","county_w2","county_w3","county_w4","county_w5","county_w6","county_w7","county_w8","county_w9","county_w10","county_w11","county_w12","county_w13","county_w14","county_w15","county_w16","county_w17","county_w18","county_w19","county_w20","county_w21","county_w22","county_w23","county_w24","county_w25","county_w26","county_w27")
names(list_age_stan_symptomatic) <-  c("age_w1","age_w2","age_w3","age_w4","age_w5","age_w6","age_w7","age_w8","age_w9","age_w10","age_w11","age_w12","age_w13","age_w14","age_w15","age_w16","age_w17","age_w18","age_w19","age_w20","age_w21","age_w22","age_w23","age_w24","age_w25","age_w26","age_w27")
names(list_race_stan_symptomatic) <-  c("race_w1","race_w2","race_w3","race_w4","race_w5","race_w6","race_w7","race_w8","race_w9","race_w10","race_w11","race_w12","race_w13","race_w14","race_w15","race_w16","race_w17","race_w18","race_w19","race_w20","race_w21","race_w22","race_w23","race_w24","race_w25","race_w26","race_w27")
names(list_sex_stan_symptomatic) <-  c("male_w1","male_w2","male_w3","male_w4","male_w5","male_w6","male_w7","male_w8","male_w9","male_w10","male_w11","male_w12","male_w13","male_w14","male_w15","male_w16","male_w17","male_w18","male_w19","male_w20","male_w21","male_w22","male_w23","male_w24","male_w25","male_w26","male_w27")
names(list_week_symptomatic) <-  c("time_w1","time_w2","time_w3","time_w4","time_w5","time_w6","time_w7","time_w8","time_w9","time_w10","time_w11","time_w12","time_w13","time_w14","time_w15","time_w16","time_w17","time_w18","time_w19","time_w20","time_w21","time_w22","time_w23","time_w24","time_w25","time_w26","time_w27")
supplementary_info_symptomatic <- list(offset = 0.5, n1 = N_symptomatic[1],n2 = N_symptomatic[2], n3 = N_symptomatic[3], n4 = N_symptomatic[4], n5 = N_symptomatic[5], n6 = N_symptomatic[6], n7 = N_symptomatic[7], n8 = N_symptomatic[8], n9 = N_symptomatic[9], n10 = N_symptomatic[10], n11 = N_symptomatic[11], n12 = N_symptomatic[12], n13 = N_symptomatic[13], n14 = N_symptomatic[14], n15 = N_symptomatic[15], n16 = N_symptomatic[16], n17 = N_symptomatic[17], n18 = N_symptomatic[18], n19 = N_symptomatic[19], n20 = N_symptomatic[20], n21 = N_symptomatic[21], n22 = N_symptomatic[22], n23 = N_symptomatic[23], n24 = N_symptomatic[24], n25 = N_symptomatic[25], n26 = N_symptomatic[26], n27 = N_symptomatic[27])
...
fit_pcr_symptomatic <- readRDS("fit_pcr_1107_symptomatic.rds")
...
```{r}
state_hospitalization <- read.csv("./hospitalization_1111.csv")
...
state_hospitalization_mrp <- data.frame(rep(seq(from = 1, to = 28, by = 1), 3),
                                        ...
                                        c(rep("State_bed_occupancy", 28),rep("State_ventilator_occupancy", 28),rep("MRP_community",28)))
...
ggplot()+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.3))+
  scale_x_continuous(breaks=seq(from=1,to=28, by = 1),labels = c(
