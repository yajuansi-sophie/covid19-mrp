...
patient_data <- read_csv(file= "./UM1123.csv", na = c("", "#NUM!"))
...
mutate(pcr_week_ind = week(strptime(result_date_time,"%m/%d/%Y %H:%M")),  #Need to be careful about whether using %Y(918 data) or %y(808 data)
  ...
  filter(pcr_week_ind <= 47)
str(patient_data)

patient_data_symptomatic <- read_csv(file = "./UM1123sx.csv", na = c("", "#NUM!"))
...
mrp_pcr_fit = readRDS("fit_pcr_1123_asymptomatic.rds")
...
fit_pcr_symptomatic = readRDS("fit_pcr_1123_symptomatic.rds")
...
fit_pcr_spline <- readRDS("fit_pcr_spline_1123_asymptomatic.rds")
...
##########Posterior prediction distribution
fit_pcr_spline_symptomatic  <- readRDS("fit_pcr_spline_1123_symptomatic.rds")
...
```{r}
state_hospitalization <- read.csv("./hospitalization_1123.csv")
...
```{r}
district1_hospitalization<- read.csv("./Distrcit1_hospitalization_1123.csv")
...
### County Level test
```{r}
county_data <- read.csv("./county_1123.csv")
...
fit_pcr_spline_1123_asymptomatic <- stan(file = "spline_pps_1123.stan", data =patient_pps_data_spline ,refresh=0, cores=7,iter = 10000,chains=2) 
saveRDS(fit_pcr_spline_1123_asymptomatic, "fit_pcr_spline_1123_asymptomatic.rds")
fit_pcr_spline_1123_symptomatic <- stan(file = "spline_pps_symptomatic_1123.stan", data =patient_pps_data_spline_symptomatic ,refresh=0, cores=7,iter = 10000,chains=2) 
saveRDS(fit_pcr_spline_1123_symptomatic, "fit_pcr_spline_1123_symptomatic.rds")

fit_pcr_1123_asymptomatic <- stan(file = "MRP_pcr_prediction_pps_1123.stan", data = patient_pps_data,refresh=0, cores=7,iter = 10000,chains=2)
saveRDS(fit_pcr_1123_asymptomatic, "fit_pcr_1123_asymptomatic.rds")
fit_pcr_1123_symptomatic <- stan(file = "MRP_pcr_prediction_pps_symptomatic_1123.stan", data = patient_pps_data_symptomatic,refresh=0, cores=7,iter = 10000,chains=2)
saveRDS(fit_pcr_1123_symptomatic, "fit_pcr_1123_symptomatic.rds")
```
...
MRP_Positivity <- data.frame(rep(seq(from = 36, to = 47, by = 1), 2),
                                        ...
                                        c(rep("MRP", 12),rep("Lake&Porter Positivity",12)))
