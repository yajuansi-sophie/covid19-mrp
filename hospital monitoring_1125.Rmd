...
ggplot(data =PCR_prevalence_by_week, aes(x = as.numeric(pcr_week_ind),y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=PCR_prevalence_by_week$pcr_week_ind[1],to=max(PCR_prevalence_by_week$pcr_week_ind)+1, by = 4),labels = c("Apr","May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw() +
...
ggplot(data =PCR_prevalence_by_week_symptomatic, aes(x = as.numeric(pcr_week_ind),y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=min(PCR_prevalence_by_week_symptomatic$pcr_week_ind),to=max(PCR_prevalence_by_week_symptomatic$pcr_week_ind)+1, by = 4),labels = c("May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+
...
count_comparison_plot <- ggplot(data =count_comparison, aes(x = count_comparison[,1] ,y =  count_comparison[,2] ))+
  ...
  scale_x_continuous(breaks=seq(from=min(count_comparison$week),to=max(count_comparison$week) +1, by = 4),labels = c("May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+
...
sex_dist=ggplot()+
  ...
  scale_x_continuous(breaks=seq(from=min(sex_pct$pcr_week_ind),to=max(sex_pct$pcr_week_ind)+1, by = 4),labels = c("Apr", "May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+
...
race_dist=ggplot()+
  ...
  labs (title = "", x = "Week", y = "Proportion")+
  scale_x_continuous(breaks=seq(from=min(race_pct$pcr_week_ind),to=max(race_pct$pcr_week_ind)+1, by = 4),labels = c("Apr","May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+
    theme(axis.text.x = element_text(hjust = 1.2),axis.text.y = element_text(size=9))+
  theme(legend.position="bottom",legend.text = element_text(size=8))
...
age_dist=ggplot()+
  ...
  labs (title = "", x = "Week", y = "Proportion")+ 
  scale_x_continuous(breaks=seq(from=min(age_pct$pcr_week_ind),to=max(age_pct$pcr_week_ind) + 1, by = 4),labels = c("Apr", "May","Jun","July","Aug","Sep","Oct","Nov"))+
    theme_bw()+
  theme(axis.text.x = element_text(hjust = 1.2),axis.text.y = element_text(size=9))+
...
mrp_pcr_fit = readRDS("~/Dropbox (University of Michigan)/MRRP_918 Data/fit_pcr_1119_asymptomatic.rds")
...
ggplot(data=est_raw_1, aes(x=week,y=est,group=type,colour=type))+
  ...
  scale_x_continuous(breaks=seq(from=min(est_raw_1$week),to=max(est_raw_1$week)+1, by = 4),labels = c("Apr","May","Jun","July","Aug","Sep","Oct","Nov"))+
...
fit_pcr_symptomatic=readRDS("~/Dropbox (University of Michigan)/MRRP_918 Data/fit_pcr_1119_symptomatic.rds")
...
ggplot(data=est_raw_symptomatic, aes(x=week,y=est,group=type,colour=type))+
  ...
  labs (title = "", x = "Week", y = "PCR Prevalence")+
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.6))+
  scale_x_continuous(breaks=seq(from=min(est_raw_symptomatic$week),to=max(est_raw_symptomatic$week)+1, by = 4),labels = c("May","Jun","July","Aug","Sep","Oct","Nov"))+
...
combine_plot = ggplot(data=combine_v, aes(x=week,y=est,group=type,colour=type))+
  ...
  labs (title = "", x = "Week", y = "PCR Prevalence")+
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.5))+
  scale_x_continuous(breaks=seq(from=min(combine_v$week),to=max(combine_v$week)+1, by = 4),labels = c("May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+theme(axis.text.x = element_text(hjust = -1),legend.position="bottom",legend.title=element_blank(),legend.text = element_text(size=9))
...
combine_plot_asym = ggplot(data=combine_v_asym, aes(x=week,y=est,group=type,colour=type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.6))+
  scale_x_continuous(breaks=seq(from=min(combine_v_asym$week),to=max(combine_v_asym$week)+1, by = 4),labels = c("May","Jun","July","Aug","Sep","Oct","Nov"))+
  theme_bw()+theme(axis.text.x = element_text(hjust = -1),legend.position="bottom",legend.title=element_blank(),legend.text = element_text(size=9))
