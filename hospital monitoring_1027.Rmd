...
count_comparison_plot <- ggplot(data =count_comparison, aes(x = count_comparison[,1] ,y =  count_comparison[,2] ))+
  geom_point() +
  geom_line()+
  labs(title = "", x = "Week", y = "Count ratio of asymptomatic and symptomatic PCR tests")+
...
mrp_pcr_fit=fit_pcr_1028_sen55
...
fit_IGG = readRDS("fit_igg1021.rds")
#
...
fit_IGG_symptomatic = readRDS("fit_igg_symptomatic1021.rds")
