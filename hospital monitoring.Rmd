...
ggplot(data =state_data_by_week, aes(x = week_ind,y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=10,to=39, by = 1),labels = c("Mar03 - Mar09","Mar10 - Mar16","Mar17 - Mar23","Mar24 - Mar30","Mar31 - Apr6","Apr7 - Apr13","Apr14 - Apr20","Apr21 - Apr27","Apr28 - May4","May5 - May11",
...
#saveRDS(fit_pcr_symptomatic, "fit_pcr_symptomatic0918a.rds")
...
#saveRDS(fit_IGG_symptomatic, "fit_igg_symptomatic0918b.rds")
