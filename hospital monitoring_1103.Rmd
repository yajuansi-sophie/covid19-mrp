...
state_data <- read.csv("./covid_report_county_region_date_1027.csv")
...
ggplot(data =state_data_by_week, aes(x = week_ind,y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=9,to=43, by = 1),labels = c("Feb25 - Mar02","Mar03 - Mar09","Mar10 - Mar16","Mar17 - Mar23","Mar24 - Mar30","Mar31 - Apr6","Apr7 - Apr13","Apr14 - Apr20","Apr21 - Apr27","Apr28 - May4","May5 - May11",
...
patient_data <- read_csv(file= "./UM1027.csv", na = c("", "#NUM!"))
...
patient_data_symptomatic <- read_csv(file = "./UM1027sx.csv", na = c("", "#NUM!"))
...
```{r, echo = FALSE,message=FALSE}
ratio_approximated <- PCR_prevalence_by_week$total_patient[2:26]/ PCR_prevalence_by_week_symptomatic$total_patient[1:25]
count_comparison <- data.frame(PCR_prevalence_by_week$pcr_week_ind[2:26], ratio_approximated)
...
count_comparison_plot <- ggplot(data =count_comparison, aes(x = count_comparison[,1] ,y =  count_comparison[,2] ))+
  ...
  scale_x_continuous(breaks=seq(from=min(count_comparison$PCR_prevalence_by_week.pcr_week_ind.2.26.),to=max(count_comparison$PCR_prevalence_by_week.pcr_week_ind.2.26.), by = 1),labels = c("May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26"))+
  theme_bw()+
...
IGG_ratio_approximated <- IGG_prevalence_by_week$total_patient[1:26]/ IGG_prevalence_by_week_symptomatic$total_patient[1:26]
IGG_count_comparison <- data.frame(IGG_prevalence_by_week$igg_week_ind[1:26], IGG_ratio_approximated)
...
IGG_count_comparison_plot <- ggplot(data =IGG_count_comparison, aes(x = IGG_count_comparison[,1] ,y =  IGG_count_comparison[,2] ))+
  ...
  scale_x_continuous(breaks=seq(from=min(IGG_count_comparison$IGG_prevalence_by_week.igg_week_ind.1.26.),to=max(IGG_count_comparison$IGG_prevalence_by_week.igg_week_ind.1.26.), by = 1),labels = c("Apr28 - May4","May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26"))+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),axis.text.y = element_text(size=9))
...
mrp_pcr_fit = readRDS("fit_pcr_1027_Andrew.rds")
...
sex_ratio <- data.frame(rep(seq(from = 20, to = 43, by = 1), 2),
                   c(sex_prevalence$prevalence_male[3:26]/sex_prevalence_symptotic$prevalence_male[2:25], sex_prevalence$prevalence_female[3:26]/sex_prevalence_symptotic$prevalence_female[2:25]),
                   c(rep("Male", length(sex_prevalence_symptotic$pcr_week_ind[2:25])),rep("Female", length(sex_prevalence_symptotic$pcr_week_ind[2:25]))))
...
ggplot()+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 0.25))+
  scale_x_continuous(breaks=seq(from=20,to=43, by = 1),labels = c(
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26"))+
  theme_bw()+
    theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),axis.text.y = element_text(size=9))+
...
#Starting from Week 20 to avoid 0/0
race_ratio <- data.frame(rep(seq(from = 20, to = 43, by = 1), 3),
                         c(race_prevalence$prevalence_white[3:26]/race_prevalence_symptotic$prevalence_white[2:25],
                           race_prevalence$prevalence_black[3:26]/race_prevalence_symptotic$prevalence_black[2:25],
                           race_prevalence$prevalence_other[3:26]/race_prevalence_symptotic$prevalence_other[2:25]),
                         c(rep("White", length(race_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Black", length(race_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Other", length(race_prevalence_symptotic$pcr_week_ind[2:25]))))
...
#Starting from Week 20 to avoid 0/0
age_ratio <- data.frame(rep(seq(from = 20, to = 43, by = 1), 5),
                         c(age_prevalence$prevalence_age1[3:26]/age_prevalence_symptotic$prevalence_age1[2:25],
                           age_prevalence$prevalence_age2[3:26]/age_prevalence_symptotic$prevalence_age2[2:25],
                           age_prevalence$prevalence_age3[3:26]/age_prevalence_symptotic$prevalence_age3[2:25],
                           age_prevalence$prevalence_age4[3:26]/age_prevalence_symptotic$prevalence_age4[2:25],
                           age_prevalence$prevalence_age5[3:26]/age_prevalence_symptotic$prevalence_age5[2:25]),
                         c(rep("Age0_17", length(age_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Age18_39", length(age_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Age40_64", length(age_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Age65_75", length(age_prevalence_symptotic$pcr_week_ind[2:25])),
                           rep("Age75+", length(age_prevalence_symptotic$pcr_week_ind[2:25]))))
