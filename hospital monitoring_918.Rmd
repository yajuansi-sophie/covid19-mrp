...
patient_data <- read_csv(file= "./UM918x.csv", na = c("", "#NUM!"))
...
PCR_prevalence_by_week_plot <- ggplot(data =PCR_prevalence_by_week, aes(x = as.numeric(pcr_week_ind),y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=18,to=38, by = 1),labels = c("Apr28 - May4","May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21"))+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
...
count_comparison <- data.frame(PCR_prevalence_by_week$pcr_week_ind[-c(1,14:21)], ratio_approximated)
...
IGG_ratio_approximated <- IGG_prevalence_by_week$total_patient[-c(14:21)]/ IGG_prevalence_by_week_symptomatic$total_patient
IGG_count_comparison <- data.frame(IGG_prevalence_by_week$igg_week_ind[-c(14:21)], IGG_ratio_approximated)
...
fit_pcr_918_Yajuan=readRDS("fit_pcr_918_Yajuan.rds")
fit_pcr_918_Andrew=readRDS("fit_pcr_918_Andrew.rds")
...
MRP_plot <- ggplot(data=est_raw_1, aes(x=week,y=est,group=type,colour=type))+
  ...
  scale_x_continuous(breaks=seq(from=18,to=38, by = 1),labels = c("Apr28 - May4","May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21"))+
  theme_bw()+theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5),legend.position="bottom",legend.title=element_blank(),legend.text = element_text(size=9))
