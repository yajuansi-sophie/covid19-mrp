...
data {
  ...
  int<lower = 1, upper = J_time> sex_time[N];
  ...
  int<lower = 1, upper = J_time> sex_time_w1[n1];
  vector[n2] male_w2;
  int time_w2[n2];
  ...
  int<lower = 1, upper = J_time> sex_time_w2[n2];
  vector[n3] male_w3;
  int time_w3[n3];
  ...
  int<lower = 1, upper = J_time> sex_time_w3[n3];
  vector[n4] male_w4;
  int time_w4[n4];
  ...
  int<lower = 1, upper = J_time> sex_time_w4[n4];
  vector[n5] male_w5;
  int time_w5[n5];
  ...
  int<lower = 1, upper = J_time> sex_time_w5[n5];
  vector[n6] male_w6;
  int time_w6[n6];
  ...
  int<lower = 1, upper = J_time> sex_time_w6[n6];
  vector[n7] male_w7;
  int time_w7[n7];
  ...
  int<lower = 1, upper = J_time> sex_time_w7[n7];
  vector[n8] male_w8;
  int time_w8[n8];
  ...
  int<lower = 1, upper = J_time> sex_time_w8[n8];
  vector[n9] male_w9;
  int time_w9[n9];
  ...
  int<lower = 1, upper = J_time> sex_time_w9[n9];
  vector[n10] male_w10;
  int time_w10[n10];
  ...
  int<lower = 1, upper = J_time> sex_time_w10[n10];
  vector[n11] male_w11;
  int time_w11[n11];
  ...
  int<lower = 1, upper = J_time> sex_time_w11[n11];
  vector[n12] male_w12;
  int time_w12[n12];
  ...
  int<lower = 1, upper = J_time> sex_time_w12[n12];
  vector[n13] male_w13;
  int time_w13[n13];
  ...
  int<lower = 1, upper = J_time> sex_time_w13[n13];
  vector[n14] male_w14;
  int time_w14[n14];
  ...
  int<lower = 1, upper = J_time> sex_time_w14[n14];
  vector[n15] male_w15;
  int time_w15[n15];
  ...
  int<lower = 1, upper = J_time> sex_time_w15[n15];
  vector[n16] male_w16;
  int time_w16[n16];
  ...
  int<lower = 1, upper = J_time> sex_time_w16[n16];
  vector[n17] male_w17;
  int time_w17[n17];
  ...
  int<lower = 1, upper = J_time> sex_time_w17[n17];
  vector[n18] male_w18;
  int time_w18[n18];
  ...
  int<lower = 1, upper = J_time> sex_time_w18[n18];
  vector[n19] male_w19;
  int time_w19[n19];
  ...
  int<lower = 1, upper = J_time> sex_time_w19[n19];
  vector[n20] male_w20;
  int time_w20[n20];
  ...
  int<lower = 1, upper = J_time> sex_time_w20[n20];
  vector[n21] male_w21;
  int time_w21[n21];
  ...
  int<lower = 1, upper = J_time> sex_time_w21[n21];
  vector[n22] male_w22;
  int time_w22[n22];
  ...
  int<lower = 1, upper = J_time> sex_time_w22[n22];
  vector[n23] male_w23;
  int time_w23[n23];
  ...
  int<lower = 1, upper = J_time> sex_time_w23[n23];
  vector[n24] male_w24;
  int time_w24[n24];
  ...
  int<lower = 1, upper = J_time> sex_time_w24[n24];
  vector[n25] male_w25;
  int time_w25[n25];
  ...
  int<lower = 1, upper = J_time> sex_time_w25[n25];
  vector[n26] male_w26;
  int time_w26[n26];
  ...
  int<lower = 1, upper = J_time> sex_time_w26[n26];
  vector[n27] male_w27;
  int time_w27[n27];
  ...
  int<lower = 1, upper = J_time> sex_time_w27[n27];
  vector[n28] male_w28;
  int time_w28[n28];
  ...
  int<lower = 1, upper = J_time> sex_time_w28[n28];
  vector[n29] male_w29;
  int time_w29[n29];
  int<lower = 1, upper = 3> race_w29[n29];  
  int<lower = 1, upper = 5> age_w29[n29];  
  int<lower = 1, upper = 2> county_w29[n29];
  int<lower = 1, upper = 5> sex_age_w29[n29];
  int<lower = 1, upper = J_time> sex_time_w29[n29];
  vector[n30] male_w30;
  int time_w30[n30];
  int<lower = 1, upper = 3> race_w30[n30];  
  int<lower = 1, upper = 5> age_w30[n30];  
  int<lower = 1, upper = 2> county_w30[n30];
  int<lower = 1, upper = 5> sex_age_w30[n30];
  int<lower = 1, upper = J_time> sex_time_w30[n30];
  vector[n31] male_w31;
  int time_w31[n31];
  int<lower = 1, upper = 3> race_w31[n31];  
  int<lower = 1, upper = 5> age_w31[n31];  
  int<lower = 1, upper = 2> county_w31[n31];
  int<lower = 1, upper = 5> sex_age_w31[n31];
  int<lower = 1, upper = J_time> sex_time_w31[n31];
}
parameters {
  real mu_logit_spec;
  real mu_logit_sens;
  ...
  vector<multiplier = sigma_sextime>[J_time] a_sextime;
}
transformed parameters { 
  vector[J_spec] spec; 
  vector[J_sens] sens;
  vector[N] a_sexage_trans;
  vector[N] a_sextime_trans;
  spec = inv_logit(logit_spec); 
  sens = inv_logit(logit_sens);
  for (i in 1:N){
  a_sexage_trans[i] = (male[i] + 0.5)*a_sexage[sex_age[i]];
  a_sextime_trans[i] = (male[i] + 0.5)*a_sextime[sex_time[i]];
  }
}
model {
  vector[N] p;
  vector[N] p_sample;
  p = inv_logit(b[1] + b[2]*male  + a_race[race] + a_age[age] + a_sexage_trans + a_time[week] + a_county[county] + a_sextime_trans); 
  ...
  a_sextime ~ normal(0, sigma_sextime);
  ...
  sigma_sextime ~ normal(0, coef_prior_scale);
...
//posterior predictive check
  vector[n1] logit_p_w1 = inv_logit(b[1] + b[2]*male_w1  + a_race[race_w1] + a_age[age_w1] + (male_w1 + offset) .* a_sexage[sex_age_w1] + a_time[time_w1] + a_county[county_w1]+
  (male_w1 + offset) .* a_sextime[sex_time_w1]);
  int<lower = 0> y_rep_w1[n1] = bernoulli_rng(logit_p_w1*sens[1] + (1-logit_p_w1)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w1 = mean(to_vector(y_rep_w1));
  real<lower = 0> sd_y_rep_w1 = sd(to_vector(y_rep_w1));
  vector[n2] logit_p_w2 = inv_logit(b[1] + b[2]*male_w2  + a_race[race_w2] + a_age[age_w2] + (male_w2 + offset) .* a_sexage[sex_age_w2] + a_time[time_w2] + a_county[county_w2]+
  (male_w2 + offset) .* a_sextime[sex_time_w2]);
  int<lower = 0> y_rep_w2[n2] = bernoulli_rng(logit_p_w2*sens[1] + (1-logit_p_w2)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w2 = mean(to_vector(y_rep_w2));
  real<lower = 0> sd_y_rep_w2 = sd(to_vector(y_rep_w2));
  vector[n3] logit_p_w3 = inv_logit(b[1] + b[2]*male_w3  + a_race[race_w3] + a_age[age_w3] + (male_w3 + offset) .* a_sexage[sex_age_w3] + a_time[time_w3] + a_county[county_w3]+
  (male_w3 + offset) .* a_sextime[sex_time_w3]);
  int<lower = 0> y_rep_w3[n3] = bernoulli_rng(logit_p_w3*sens[1] + (1-logit_p_w3)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w3 = mean(to_vector(y_rep_w3));
  real<lower = 0> sd_y_rep_w3 = sd(to_vector(y_rep_w3));
  vector[n4] logit_p_w4 = inv_logit(b[1] + b[2]*male_w4  + a_race[race_w4] + a_age[age_w4] + (male_w4 + offset) .* a_sexage[sex_age_w4] + a_time[time_w4] + a_county[county_w4]+
  (male_w4 + offset) .* a_sextime[sex_time_w4]);
  int<lower = 0> y_rep_w4[n4] = bernoulli_rng(logit_p_w4*sens[1] + (1-logit_p_w4)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w4 = mean(to_vector(y_rep_w4));
  real<lower = 0> sd_y_rep_w4 = sd(to_vector(y_rep_w4));
  vector[n5] logit_p_w5 = inv_logit(b[1] + b[2]*male_w5  + a_race[race_w5] + a_age[age_w5] + (male_w5 + offset) .* a_sexage[sex_age_w5] + a_time[time_w5] + a_county[county_w5]+
  (male_w5 + offset) .* a_sextime[sex_time_w5]);
  int<lower = 0> y_rep_w5[n5] = bernoulli_rng(logit_p_w5*sens[1] + (1-logit_p_w5)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w5 = mean(to_vector(y_rep_w5));
  real<lower = 0> sd_y_rep_w5 = sd(to_vector(y_rep_w5));
  vector[n6] logit_p_w6 = inv_logit(b[1] + b[2]*male_w6 + a_race[race_w6] + a_age[age_w6] + (male_w6 + offset) .* a_sexage[sex_age_w6] + a_time[time_w6] + a_county[county_w6]+
  (male_w6 + offset) .* a_sextime[sex_time_w6]);
  int<lower = 0> y_rep_w6[n6] = bernoulli_rng(logit_p_w6*sens[1] + (1-logit_p_w6)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w6 = mean(to_vector(y_rep_w6));
  real<lower = 0> sd_y_rep_w6 = sd(to_vector(y_rep_w6));
  vector[n7] logit_p_w7 = inv_logit(b[1] + b[2]*male_w7 + a_race[race_w7] + a_age[age_w7] + (male_w7 + offset) .* a_sexage[sex_age_w7] + a_time[time_w7] + a_county[county_w7]+
  (male_w7 + offset) .* a_sextime[sex_time_w7]);
  int<lower = 0> y_rep_w7[n7] = bernoulli_rng(logit_p_w7*sens[1] + (1-logit_p_w7)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w7 = mean(to_vector(y_rep_w7));
  real<lower = 0> sd_y_rep_w7 = sd(to_vector(y_rep_w7));
  vector[n8] logit_p_w8 = inv_logit(b[1] + b[2]*male_w8  + a_race[race_w8] + a_age[age_w8] + (male_w8 + offset) .* a_sexage[sex_age_w8] + a_time[time_w8] + a_county[county_w8]+
  (male_w8 + offset) .* a_sextime[sex_time_w8]);
  int<lower = 0> y_rep_w8[n8] = bernoulli_rng(logit_p_w8*sens[1] + (1-logit_p_w8)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w8 = mean(to_vector(y_rep_w8));
  real<lower = 0> sd_y_rep_w8 = sd(to_vector(y_rep_w8));
  vector[n9] logit_p_w9 = inv_logit(b[1] + b[2]*male_w9  + a_race[race_w9] + a_age[age_w9] + (male_w9 + offset) .* a_sexage[sex_age_w9] + a_time[time_w9] + a_county[county_w9]+
  (male_w9 + offset) .* a_sextime[sex_time_w9]);
  int<lower = 0> y_rep_w9[n9] = bernoulli_rng(logit_p_w9*sens[1] + (1-logit_p_w9)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w9 = mean(to_vector(y_rep_w9));
  real<lower = 0> sd_y_rep_w9 = sd(to_vector(y_rep_w9));
  vector[n10] logit_p_w10 = inv_logit(b[1] + b[2]*male_w10  + a_race[race_w10] + a_age[age_w10] + (male_w10 + offset) .* a_sexage[sex_age_w10] + a_time[time_w10] + a_county[county_w10]+(male_w10 + offset) .* a_sextime[sex_time_w10]);
  int<lower = 0> y_rep_w10[n10] = bernoulli_rng(logit_p_w10*sens[1] + (1-logit_p_w10)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w10 = mean(to_vector(y_rep_w10));
  real<lower = 0> sd_y_rep_w10 = sd(to_vector(y_rep_w10));
  vector[n11] logit_p_w11 = inv_logit(b[1] + b[2]*male_w11  + a_race[race_w11] + a_age[age_w11] + (male_w11 + offset) .* a_sexage[sex_age_w11] + a_time[time_w11] + a_county[county_w11]+(male_w11 + offset) .* a_sextime[sex_time_w11]);
  int<lower = 0> y_rep_w11[n11] = bernoulli_rng(logit_p_w11*sens[1] + (1-logit_p_w11)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w11 = mean(to_vector(y_rep_w11));
  real<lower = 0> sd_y_rep_w11 = sd(to_vector(y_rep_w11));
  vector[n12] logit_p_w12 = inv_logit(b[1] + b[2]*male_w12  + a_race[race_w12] + a_age[age_w12] + (male_w12 + offset) .* a_sexage[sex_age_w12] + a_time[time_w12] + a_county[county_w12]+(male_w12 + offset) .* a_sextime[sex_time_w12]);
  int<lower = 0> y_rep_w12[n12] = bernoulli_rng(logit_p_w12*sens[1] + (1-logit_p_w12)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w12 = mean(to_vector(y_rep_w12));
  real<lower = 0> sd_y_rep_w12 = sd(to_vector(y_rep_w12));
  vector[n13] logit_p_w13 = inv_logit(b[1] + b[2]*male_w13  + a_race[race_w13] + a_age[age_w13] + (male_w13 + offset) .* a_sexage[sex_age_w13] + a_time[time_w13] + a_county[county_w13]+(male_w13 + offset) .* a_sextime[sex_time_w13]);
  int<lower = 0> y_rep_w13[n13] = bernoulli_rng(logit_p_w13*sens[1] + (1-logit_p_w13)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w13 = mean(to_vector(y_rep_w13));
  real<lower = 0> sd_y_rep_w13 = sd(to_vector(y_rep_w13));
  vector[n14] logit_p_w14 = inv_logit(b[1] + b[2]*male_w14  + a_race[race_w14] + a_age[age_w14] + (male_w14 + offset) .* a_sexage[sex_age_w14] + a_time[time_w14] + a_county[county_w14]+(male_w14 + offset) .* a_sextime[sex_time_w14]);
  int<lower = 0> y_rep_w14[n14] = bernoulli_rng(logit_p_w14*sens[1] + (1-logit_p_w14)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w14 = mean(to_vector(y_rep_w14));
  real<lower = 0> sd_y_rep_w14 = sd(to_vector(y_rep_w14));
  vector[n15] logit_p_w15 = inv_logit(b[1] + b[2]*male_w15  + a_race[race_w15] + a_age[age_w15] + (male_w15 + offset) .* a_sexage[sex_age_w15] + a_time[time_w15] + a_county[county_w15]+(male_w15 + offset) .* a_sextime[sex_time_w15]);
  int<lower = 0> y_rep_w15[n15] = bernoulli_rng(logit_p_w15*sens[1] + (1-logit_p_w15)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w15 = mean(to_vector(y_rep_w15));
  real<lower = 0> sd_y_rep_w15 = sd(to_vector(y_rep_w15));
  vector[n16] logit_p_w16 = inv_logit(b[1] + b[2]*male_w16  + a_race[race_w16] + a_age[age_w16] + (male_w16 + offset) .* a_sexage[sex_age_w16] + a_time[time_w16] + a_county[county_w16]+(male_w16 + offset) .* a_sextime[sex_time_w16]);
  int<lower = 0> y_rep_w16[n16] = bernoulli_rng(logit_p_w16*sens[1] + (1-logit_p_w16)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w16 = mean(to_vector(y_rep_w16));
  real<lower = 0> sd_y_rep_w16 = sd(to_vector(y_rep_w16));
  vector[n17] logit_p_w17 = inv_logit(b[1] + b[2]*male_w17  + a_race[race_w17] + a_age[age_w17] + (male_w17 + offset) .* a_sexage[sex_age_w17] + a_time[time_w17] + a_county[county_w17]+(male_w17 + offset) .* a_sextime[sex_time_w17]);
  int<lower = 0> y_rep_w17[n17] = bernoulli_rng(logit_p_w17*sens[1] + (1-logit_p_w17)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w17 = mean(to_vector(y_rep_w17));
  real<lower = 0> sd_y_rep_w17 = sd(to_vector(y_rep_w17));
  vector[n18] logit_p_w18 = inv_logit(b[1] + b[2]*male_w18  + a_race[race_w18] + a_age[age_w18] + (male_w18 + offset) .* a_sexage[sex_age_w18] + a_time[time_w18] + a_county[county_w18]+(male_w18 + offset) .* a_sextime[sex_time_w18]);
  int<lower = 0> y_rep_w18[n18] = bernoulli_rng(logit_p_w18*sens[1] + (1-logit_p_w18)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w18 = mean(to_vector(y_rep_w18));
  real<lower = 0> sd_y_rep_w18 = sd(to_vector(y_rep_w18));
  vector[n19] logit_p_w19 = inv_logit(b[1] + b[2]*male_w19  + a_race[race_w19] + a_age[age_w19] + (male_w19 + offset) .* a_sexage[sex_age_w19] + a_time[time_w19] + a_county[county_w19]+(male_w19 + offset) .* a_sextime[sex_time_w19]);
  int<lower = 0> y_rep_w19[n19] = bernoulli_rng(logit_p_w19*sens[1] + (1-logit_p_w19)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w19 = mean(to_vector(y_rep_w19));
  real<lower = 0> sd_y_rep_w19 = sd(to_vector(y_rep_w19));
  vector[n20] logit_p_w20 = inv_logit(b[1] + b[2]*male_w20  + a_race[race_w20] + a_age[age_w20] + (male_w20 + offset) .* a_sexage[sex_age_w20] + a_time[time_w20] + a_county[county_w20]+(male_w20 + offset) .* a_sextime[sex_time_w20]);
  int<lower = 0> y_rep_w20[n20] = bernoulli_rng(logit_p_w20*sens[1] + (1-logit_p_w20)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w20 = mean(to_vector(y_rep_w20));
  real<lower = 0> sd_y_rep_w20 = sd(to_vector(y_rep_w20));
  vector[n21] logit_p_w21 = inv_logit(b[1] + b[2]*male_w21  + a_race[race_w21] + a_age[age_w21] + (male_w21 + offset) .* a_sexage[sex_age_w21] + a_time[time_w21] + a_county[county_w21]+(male_w21 + offset) .* a_sextime[sex_time_w21]);
  int<lower = 0> y_rep_w21[n21] = bernoulli_rng(logit_p_w21*sens[1] + (1-logit_p_w21)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w21 = mean(to_vector(y_rep_w21));
  real<lower = 0> sd_y_rep_w21 = sd(to_vector(y_rep_w21));
  vector[n22] logit_p_w22 = inv_logit(b[1] + b[2]*male_w22  + a_race[race_w22] + a_age[age_w22] + (male_w22 + offset) .* a_sexage[sex_age_w22] + a_time[time_w22] + a_county[county_w22]+(male_w22 + offset) .* a_sextime[sex_time_w22]);
  int<lower = 0> y_rep_w22[n22] = bernoulli_rng(logit_p_w22*sens[1] + (1-logit_p_w22)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w22 = mean(to_vector(y_rep_w22));
  real<lower = 0> sd_y_rep_w22 = sd(to_vector(y_rep_w22));
  vector[n23] logit_p_w23 = inv_logit(b[1] + b[2]*male_w23  + a_race[race_w23] + a_age[age_w23] + (male_w23 + offset) .* a_sexage[sex_age_w23] + a_time[time_w23] + a_county[county_w23]+(male_w23 + offset) .* a_sextime[sex_time_w23]);
  int<lower = 0> y_rep_w23[n23] = bernoulli_rng(logit_p_w23*sens[1] + (1-logit_p_w23)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w23 = mean(to_vector(y_rep_w23));
  real<lower = 0> sd_y_rep_w23 = sd(to_vector(y_rep_w23));
  vector[n24] logit_p_w24 = inv_logit(b[1] + b[2]*male_w24  + a_race[race_w24] + a_age[age_w24] + (male_w24 + offset) .* a_sexage[sex_age_w24] + a_time[time_w24] + a_county[county_w24]+(male_w24 + offset) .* a_sextime[sex_time_w24]);
  int<lower = 0> y_rep_w24[n24] = bernoulli_rng(logit_p_w24*sens[1] + (1-logit_p_w24)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w24 = mean(to_vector(y_rep_w24));
  real<lower = 0> sd_y_rep_w24 = sd(to_vector(y_rep_w24));
  vector[n25] logit_p_w25 = inv_logit(b[1] + b[2]*male_w25  + a_race[race_w25] + a_age[age_w25] + (male_w25 + offset) .* a_sexage[sex_age_w25] + a_time[time_w25] + a_county[county_w25]+(male_w25 + offset) .* a_sextime[sex_time_w25]);
  int<lower = 0> y_rep_w25[n25] = bernoulli_rng(logit_p_w25*sens[1] + (1-logit_p_w25)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w25 = mean(to_vector(y_rep_w25));
  real<lower = 0> sd_y_rep_w25 = sd(to_vector(y_rep_w25));
  vector[n26] logit_p_w26 = inv_logit(b[1] + b[2]*male_w26  + a_race[race_w26] + a_age[age_w26] + (male_w26 + offset) .* a_sexage[sex_age_w26] + a_time[time_w26] + a_county[county_w26]+(male_w26 + offset) .* a_sextime[sex_time_w26]);
  int<lower = 0> y_rep_w26[n26] = bernoulli_rng(logit_p_w26*sens[1] + (1-logit_p_w26)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w26 = mean(to_vector(y_rep_w26));
  real<lower = 0> sd_y_rep_w26 = sd(to_vector(y_rep_w26));
  vector[n27] logit_p_w27 = inv_logit(b[1] + b[2]*male_w27  + a_race[race_w27] + a_age[age_w27] + (male_w27 + offset) .* a_sexage[sex_age_w27] + a_time[time_w27] + a_county[county_w27]+(male_w27 + offset) .* a_sextime[sex_time_w27]);
  int<lower = 0> y_rep_w27[n27] = bernoulli_rng(logit_p_w27*sens[1] + (1-logit_p_w27)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w27 = mean(to_vector(y_rep_w27));
  real<lower = 0> sd_y_rep_w27 = sd(to_vector(y_rep_w27));
  vector[n28] logit_p_w28 = inv_logit(b[1] + b[2]*male_w28  + a_race[race_w28] + a_age[age_w28] + (male_w28 + offset) .* a_sexage[sex_age_w28] + a_time[time_w28] + a_county[county_w28]+(male_w28 + offset) .* a_sextime[sex_time_w28]);
  int<lower = 0> y_rep_w28[n28] = bernoulli_rng(logit_p_w28*sens[1] + (1-logit_p_w28)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w28 = mean(to_vector(y_rep_w28));
  real<lower = 0> sd_y_rep_w28 = sd(to_vector(y_rep_w28));
  vector[n29] logit_p_w29 = inv_logit(b[1] + b[2]*male_w29  + a_race[race_w29] + a_age[age_w29] + (male_w29 + offset) .* a_sexage[sex_age_w29] + a_time[time_w29] + a_county[county_w29]+(male_w29 + offset) .* a_sextime[sex_time_w29]);
  int<lower = 0> y_rep_w29[n29] = bernoulli_rng(logit_p_w29*sens[1] + (1-logit_p_w29)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w29 = mean(to_vector(y_rep_w29));
  real<lower = 0> sd_y_rep_w29 = sd(to_vector(y_rep_w29));
  vector[n30] logit_p_w30 = inv_logit(b[1] + b[2]*male_w30  + a_race[race_w30] + a_age[age_w30] + (male_w30 + offset) .* a_sexage[sex_age_w30] + a_time[time_w30] + a_county[county_w30]+(male_w30 + offset) .* a_sextime[sex_time_w30]);
  int<lower = 0> y_rep_w30[n30] = bernoulli_rng(logit_p_w30*sens[1] + (1-logit_p_w30)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w30 = mean(to_vector(y_rep_w30));
  real<lower = 0> sd_y_rep_w30 = sd(to_vector(y_rep_w30));
  vector[n31] logit_p_w31 =inv_logit(b[1] + b[2]*male_w31  + a_race[race_w31] + a_age[age_w31] + (male_w31 + offset) .* a_sexage[sex_age_w31] + a_time[time_w31] + a_county[county_w31]+(male_w31 + offset) .* a_sextime[sex_time_w31]);
  int<lower = 0> y_rep_w31[n31] = bernoulli_rng(logit_p_w31*sens[1] + (1-logit_p_w31)*(1-spec[1]));
  real<lower = 0> mean_y_rep_w31 = mean(to_vector(y_rep_w31));
  real<lower = 0> sd_y_rep_w31 = sd(to_vector(y_rep_w31));
//Marginal prevalence
    ...
    for (i_age in 1:5) {
      for (i_race in 1:3) {
          ...
          p_pop[count] = inv_logit(b[1]
                                   + b[2] * (i_male - 0.5)
                                   + a_race[i_race]
                                   + a_age[i_age]+a_time[time]+i_male*a_sexage[i_age] + a_county[i_county] + i_male * a_sextime[time]);
          ...
          p_pop_notime_up[count] = inv_logit(b[1]
                                   + b[2] * (i_male - 0.5)
                                   + a_race[i_race]
                                   + a_age[i_age]+ sigma_time + i_male*a_sexage[i_age] + a_county[i_county] + sigma_sextime);  
