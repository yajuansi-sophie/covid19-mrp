...
state_data <- read.csv("./covid_report_county_region_date_1021.csv")
...
ggplot(data =state_data_by_week, aes(x = week_ind,y = prevalence))+
  ...
  scale_x_continuous(breaks=seq(from=10,to=42, by = 1),labels = c("Mar03 - Mar09","Mar10 - Mar16","Mar17 - Mar23","Mar24 - Mar30","Mar31 - Apr6","Apr7 - Apr13","Apr14 - Apr20","Apr21 - Apr27","Apr28 - May4","May5 - May11",
                                                                "May12 - May18","May19 - May25","May26 - Jun1","Jun2 - Jun8","Jun9 - Jun15","Jun16 - Jun22","Jun23 - Jun29","Jun30 - July6","July7 - July13","July14 - July20",
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21","Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19"))+
  theme_bw()+
...
patient_data <- read_csv(file= "./UM1021.csv", na = c("", "#NUM!"))
...
patient_data_symptomatic <- read_csv(file = "./UM1021sx.csv", na = c("", "#NUM!"))
...
sex_dist=ggplot()+
  ...
  ggsave(sex_dist, file="plot/sex_dist.png")
```
...
race_dist=ggplot()+
  ...
  theme_bw()+
    theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),axis.text.y = element_text(size=9))+
  theme(legend.position="bottom",legend.text = element_text(size=8))
ggsave(race_dist, file="plot/race_dist.png")
```
...
ggsave(age_dist, file="plot/age_dist.png")
```
## MRP
...
fit_pcr_1021_Andrew <- stan(file = "MRP_pcr_Andrew.stan", data = pcr_data_stan_Andrew,refresh=0, cores=8,iter = 10000,chains=2) 
saveRDS(fit_pcr_1021_Andrew, "fit_pcr_1021_Andrew.rds")
...
MRP_sd_plot <- ggplot(data=est_raw_1, aes(x=week,y=est,group=type,colour=type))+
  ...
  scale_x_continuous(breaks=seq(from=min(est_raw_1$week),to=max(est_raw_1$week), by = 1),labels = c("Apr28 - May4","May5 - May11",
                                                                ...
                                                                "July21 - July27","July28 - Aug3","Aug4 - Aug10","Aug11 - Aug17","Aug18 - Aug24","Aug25 - Aug31","Sep1 - Sep7","Sep8 - Sep14","Sep15 - Sep21", "Sep22 - Sep28", "Sep29 - Oct5", "Oct6 - Oct12","Oct13 - Oct19", "Oct20 - Oct26"))+
  theme_bw()+theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),legend.position="bottom",legend.title=element_blank(),legend.text = element_text(size=9))
ggsave(MRP_sd_plot, file="plot/pcr_mrp_sd.png")
...
fit_pcr_symptomatic=readRDS("fit_pcr_symptomatic1021.rds")
...
ggsave(MRP_sd_symptomatic_plot, file="plot/pcr_mrp_sym_sd.png")
...
saveRDS(fit_pcr_918_sen55, "fit_pcr_1021_sen55.rds")

fit_pcr_1021_sen60 <- stan(file = "MRP_pcr_Andrew.stan", data = pcr_data_stan_sen60,refresh=0, cores=8,iter = 10000,chains=2) 
saveRDS(fit_pcr_918_sen60, "fit_pcr_1021_sen60.rds")

fit_pcr_1021_sen65 <- stan(file = "MRP_pcr_Andrew.stan", data = pcr_data_stan_sen65,refresh=0, cores=8,iter = 10000,chains=2) 
...
ggsave(MRP_IGG_sd_plot, file="plot/igg_mrp_sd.png")
...
ggsave(MRP_IGG_sd_symptomatic_plot, file="plot/igg_mrp_sym_sd.png")
...
ggsave(combine_plot, file="plot/pcr_compare.png")
...
ggsave(combine_plot_sym, file="plot/pcr_compare_sym.png")             
```
